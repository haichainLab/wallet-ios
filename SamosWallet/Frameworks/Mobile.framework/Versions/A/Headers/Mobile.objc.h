// Objective-C API for talking to wallet-api/src/api/mobile Go package.
//   gobind -lang=objc wallet-api/src/api/mobile
//
...
/**
 * in order to do some init work
 */
FOUNDATION_EXPORT BOOL MobilePreInit(NSError** error);
